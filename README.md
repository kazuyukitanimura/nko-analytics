...
# deploying (to http://nko-analytics.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@nko-analytics.2013.nodeknockout.com
ssh root@nko-analytics.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@nko-analytics.2013.nodeknockout.com
ssh -i ./id_deploy root@nko-analytics.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nko-analytics" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
